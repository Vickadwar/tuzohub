...
export default function UserDropdown() {
  ...
  const handleSignOut = async () => {
    try {
      // 1. Sign out on client to clear local state immediately
      await supabase.auth.signOut();
      
      // 2. Clear all cookies to resolve potential 431 header issues
      clearAllCookies();
      
      // 3. Call server-side sign out (best effort)
